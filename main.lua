...
gap_between_phrases = 1.25 * 1.0
phrase_padding = 0.25 * 1.0
...
function read_subtitles()
    ...
    print("TAG - finish read_subtitles - true")
    return true
end
...
function toggle_interactive_mode()
    print("TAG - start toggle_interactive_mode")
    if playback_interactive_mode ~= true then
        init_interactive_mode()
    else
        release_interactive_mode()
    end
    print("TAG - finish toggle_interactive_mode")
end

function init()
    print("TAG - Start init")
    local ret = read_subtitles()
    print("TAG - ret - ", ret)
    print("TAG - length subs - ", #subs)
    ...
    print("TAG - Finish init")
end

print("TAG - Register event")
